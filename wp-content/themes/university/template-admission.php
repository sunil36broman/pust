				...
				<div class="department_right_content">
					...
					<div class="panel-group" id="accordion">
						...
						foreach($categories as $category){
							$cat_query = null;
							$args = array (
								 'post_type' => 'admission-info',
								 'admission-category' => $category->name,
								 'posts_per_page' => 5
								);
							...
							if($cat_query->have_posts()){
								...
								//echo "<a href=\"".get_term_link( $category )."\"><h4>". $category->name ."</h4></a>";
								...
								echo '</h4></div>';
									...
									<tr> 
										...
										<td>
										<?php
										$publish_files = get_post_meta(get_the_ID(), 'admission_files_id', true);
									...
									echo '</tbody>';
									echo '</table>';
									echo "<a class=\"single_category_show\" href=\"".get_term_link( $category )."\">All Information</a>";
									echo '</div></div>';
									echo '</div>';
							}
							wp_reset_postdata();
