<?php
	...
	//all network user show bellow this coode
	/*
	$users = array();
	global $wpdb;
	...
	*/
	//current blog all user if need another user then add new user and exiting user trasfer own network site using email or username 
	$users = array();
	...
	//all page show
		...
		foreach($pages as $sing_page){
			$all_pages[$sing_page->ID]=$sing_page->post_title;
		}
	//all page show
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
           array(
                ...
                'subtitle' => __( 'Please upload logo image', 'redux-framework-demo' ),
                'default'  => array( 
							'url' =>get_template_directory_uri()."/img/pust.png",
			...
			array(
                'id'       => 'opt_media_taxt_logo',
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Upload text logo image', 'redux-framework-demo' ),
                'compiler' => true,
                'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                
                'subtitle' => __( 'Please upload text logo image', 'redux-framework-demo' ),
                'default'  => array( 
							'url' =>get_template_directory_uri()."/img/42.png",
		   ...
		   array(
                ...
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Upload Department Header Image', 'redux-framework-demo' ),
                'compiler' => true,
                'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                
                'subtitle' => __( 'Please Upload Department Header Image', 'redux-framework-demo' ),
                'default'  => array( 
							'url' =>get_template_directory_uri()."/img/img3.jpg",
...
*/
    ...
    Redux::setSection( $opt_name, array(
	 ...
	 Redux::setSection( $opt_name, array(
        'title'      => __( 'Main Site Option', 'redux-framework-demo' ),
        'id'         => 'select-image_select',
		'desc'       => __( 'Main site category selection filed', 'redux-framework-demo' ),
		'subsection' => true,
        'fields'     => array(
		
				array(
					'id'       => 'opt_multi_select_cat_iteam',
					'type'     => 'select',
					'multi'    => true,
					'title'    => __( 'Multi Select category', 'redux-framework-demo' ),
					'subtitle' => __( 'No validation can be done on this field type', 'redux-framework-demo' ),
					'desc'     => __( 'This is the description field, again good for additional info.', 'redux-framework-demo' ),
		        ...
		        array(
					'id'       => 'opt_multi_select_page_iteam',
					'type'     => 'select',
					'multi'    => true,
					'title'    => __( 'Multi Select pages', 'redux-framework-demo' ),
					'subtitle' => __( 'No validation can be done on this field type', 'redux-framework-demo' ),
					'desc'     => __( 'This is the description field, again good for additional info.', 'redux-framework-demo' ),
					'options'  =>$all_pages
					//'data'     => 'pages',
				...
				array(
					'id'       => 'opt_multi_select_page_iteam2',
					'type'     => 'select',
					'multi'    => true,
					'title'    => __( 'Multi Select pages', 'redux-framework-demo' ),
					'subtitle' => __( 'No validation can be done on this field type', 'redux-framework-demo' ),
				...
				array(
					'id'       => 'opt_multi_select_page_iteam3',
					'type'     => 'select',
					'multi'    => true,
					'title'    => __( 'Multi Select pages', 'redux-framework-demo' ),
					'subtitle' => __( 'No validation can be done on this field type', 'redux-framework-demo' ),
				...
				array(
					'id'       => 'opt_multi_select_page_iteam4',
					'type'     => 'select',
					'multi'    => true,
					'title'    => __( 'Multi Select pages', 'redux-framework-demo' ),
					'subtitle' => __( 'No validation can be done on this field type', 'redux-framework-demo' ),
				...
				array(
                'id'       => 'main_vice_or_chairman_page_selection',
                'type'     => 'select',
                'data'     => 'pages',
                'title'    => __( 'Message page selection for voice/chairman', 'redux-framework-demo' ),
               
				'default'  =>1
				),
				
				array(
                'id'       => 'faculty_parent_page_selection_for_department',
                'type'     => 'select',
                'data'     => 'pages',
                'title'    => __( 'Please select faculty page for all faculty with department', 'redux-framework-demo' ),
               
				'default'  =>1
				),
				/*
				array(
                'id'       => 'main_category_selection_for_1st',
                'type'     => 'select',
                'data'     => 'taxonomy',
                'title'    => __( 'Categories Selection For 1st', 'redux-framework-demo' ),
               
				'default'  =>1
				),
				array(
					'id'       => 'main_category_selection_for_2nd',
					'type'     => 'select',
					'data'     => 'category',
					'title'    => __( 'Categories Selection For 2nd', 'redux-framework-demo' ),
				   
					'default'  =>1
				),
			   array(
					'id'       => 'main_category_selection_for_3rd',
					'type'     => 'select',
					'data'     => 'category',
					'title'    => __( 'Categories Selection For 3rd', 'redux-framework-demo' ),
				   
					'default'  =>1
				),
				array(
					'id'       => 'main_category_selection_for_4th',
					'type'     => 'select',
					'data'     => 'category',
					'title'    => __( 'Categories Selection For 4th', 'redux-framework-demo' ),
	...
	Redux::setSection( $opt_name, array(
        'title'      => __( 'All network Site Option', 'redux-framework-demo' ),
        'id'         => 'select-vc_chair_select',
		'desc'       => __( 'Main site category selection filed', 'redux-framework-demo' ),
		'subsection' => true,
        'fields'     => array(
		
		        array(
					'id'       => 'vice-chancellor-select',
					'type'     => 'select',
					'title'    => __( 'Select Honorable Vice-Chancellor', 'redux-framework-demo' ),
					'options'  =>$users,
					'default'  =>$user_id
				),
		)
   ...
   // Redux::setSection( $opt_name, array(
    //    'title'      => __( 'Department site option', 'redux-framework-demo' ),
    //    'id'         => 'select-select',
     //   'desc'       => __( 'Deartment site category selection filed', 'redux-framework-demo' ),
    //    'subsection' => true,
    //    'fields'     => array(
			/*
            array(
                ...
                'title'    => __( 'Select Honorable Vice-Chancellor', 'redux-framework-demo' ),
                'subtitle' => __( 'No validation can be done on this field type', 'redux-framework-demo' ),
                'desc'     => __( 'Home page message show', 'redux-framework-demo' ),
           ...
           array(
                ...
                'type'     => 'select',
                'data'     => 'category',
                'title'    => __( 'News category in depertment', 'redux-framework-demo' ),
                'subtitle' => __( 'This category active for department news', 'redux-framework-demo' ),
