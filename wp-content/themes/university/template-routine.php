<?php
/*
Template Name:Class Routine template
*/
get_header(); the_post();?>
				...
				<div class="department_right_content">
					...
					<div class="panel-group" id="accordion">
						...
						foreach($categories as $category){
							...
							$args = array (
							'post_type' => 'routine',
							'routine-category' => $category->name,
							'posts_per_page' => 5
							);
							...
							if($cat_query->have_posts()){
								...
								echo '<table class="table table-bordered table-striped bs-events-table">'; 
									...
									echo '</tbody>';
									echo '</table>';
									echo "<a class=\"single_category_show\" href=\"".get_term_link( $category )."\">All routine</a>";
									echo '</div></div>';
								echo '</div>';
							}
						wp_reset_postdata();
